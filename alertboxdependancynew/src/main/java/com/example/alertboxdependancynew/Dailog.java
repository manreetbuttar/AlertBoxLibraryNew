package com.example.alertboxdependancynew;
...
public class Dailog {
    ...
    public static void showDialog(Context context, String title, String message, ArrayList<ButtonModel> tempstore,int titlecolor,int messageColor,int buttonColor
    ) {
        ...
        dialog.setCancelable(false);
            ...
            for (int i=0;i<tempstore.size();i++){
                ...
                addButton(context, tempstore.get(i).getName(), dialog,buttonColor);
    ...
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR1)
    public static void addButton(final Context context, final String buttonName1, final Dialog dialog,int buttonColor) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("BUTTON", buttonName1);
